            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                        ...
                        <h1>Update Book Collection</h1>

                        <div>
                            <c:url var="add_book_url" value="/updatebookpost" />
                            <form:form action="${add_book_url}" method="post" modelAttribute="book">
                                <div class="form-group py-1  w-75">
                                    ...
                                    <form:input type="text" path="title" cssClass="form-control" value="${book.title}"/>
                                </div>
                                <div class="form-group py-1  w-75">
                                    <form:label path="description" cssClass="text-white">Description: </form:label>
                                    <form:input type="text" path="description" cssClass="form-control" value="${book.description}"/>
                                </div>
